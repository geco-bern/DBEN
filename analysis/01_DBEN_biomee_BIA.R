...
biomee_forcing_BIA <- read.csv("data/inputs/biomee_forcing_BIA.csv")
biomee_forcing_BIA
...
#biomee_annual_tile <- read.csv("data/outputs_mod/412ppm/BiomeE_P0_BIA_aCO2_annual_tile.csv")
#biomee_annual_cohorts <- read.csv("data/outputs_mod/412ppm/BiomeE_P0_BIA_aCO2_annual_cohorts.csv")
