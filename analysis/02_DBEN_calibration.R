...
## Biomass ####
# AGcwood (aboveground woody carbon) 
benchmark_biomass <- read.csv(paste0(here::here(), "/data/benchmarking/benchmark_eq_dynamics.csv"))
...
## Stand structure ####
stand_structure <- read.csv(paste0(here::here(), "/data/benchmarking/benchmark_stand_structure.csv"))
...
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_FIN_412ppm_Calibration.pdf"),width = 6, height = 8, dpi=300)
...
plot_regrowth_out + plot_regrowth_bench + plot_biomass_out + plot_biomass_bench +
  ...
  plot_layout(ncol = 2) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_FIN_412ppm_Calibration_both.pdf"),width = 6, height = 8, dpi=300)
...
fig_regrowth + fig_biomass + fig_stems + fig_cwood +
  plot_layout(ncol = 1) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_BIA_412ppm_Calibration.pdf"),width = 6, height = 8, dpi=300)

plot_regrowth_out + plot_regrowth_bench + plot_biomass_out + plot_biomass_bench +
  plot_cwood_out + plot_cwood_bench + plot_stems_out + plot_stems_bench +
  plot_layout(ncol = 2) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_BIA_412ppm_Calibration_both.pdf"),width = 6, height = 8, dpi=300)
...
fig_regrowth + fig_biomass + fig_stems + fig_cwood +
  plot_layout(ncol = 1) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_BCI_412ppm_Calibration.pdf"),width = 6, height = 8, dpi=300)

plot_regrowth_out + plot_regrowth_bench + plot_biomass_out + plot_biomass_bench +
  plot_cwood_out + plot_cwood_bench + plot_stems_out + plot_stems_bench +
  plot_layout(ncol = 2) + 
  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
ggsave(paste0(here::here(), "/manuscript/figures/BiomeEP_P0_BCI_412ppm_Calibration_both.pdf"),width = 6, height = 8, dpi=300)
